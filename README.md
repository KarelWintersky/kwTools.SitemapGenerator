...
Теперь мы можем запустить из консоли, передав аргументом путь к файлу конфигурации:
...
На реальном проекте (163 тысячи статей/фоторепортажей) генерация занимает 3.72 секунды, пиковое потребление памяти 77 Мб.
